...
config :elixir-_learning, Elixir-LearningWeb.Router,
  session_key: get_env!("SESSION_KEY"),
  session_signing_salt: get_env!("SESSION_SIGNING_SALT")

config :elixir-_learning, Corsica, origins: get_env("CORS_ALLOWED_ORIGINS", :cors)
