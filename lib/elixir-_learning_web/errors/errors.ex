defmodule Elixir-LearningWeb.Errors do
  alias Ecto.Changeset
  alias Elixir-LearningWeb.Errors.View
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(Elixir-Learning.Gettext, "errors", message, message, options[:count], options)
    else
      Gettext.dgettext(Elixir-Learning.Gettext, "errors", message, options)
    end
  end
